...
public class EditProductToOrderHistory2 {
	...
	public static void main(String[] args) {
		...
		String userusername=fileUtility.getDataFromProperty("userusername");
		String userpassword=fileUtility.getDataFromProperty("userpassword");
		...
		if(actualProductNameInOrderHistory.equalsIgnoreCase(updatedProductName)) {
